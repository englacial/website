...
We now also have a more pressing question: "how much of this ice could end up in the oceans in the next 20 years? 50 years? 100 years?" As it turns out, knowing where the the bedrock is beneath the ice, especially in the coastal regions where ice flows out towards the ocean, is crucially important to answering this question. (If you're curious about why bedrock topography is so important to predicting sea level rise, [this is a great explainer](https://blogs.egu.eu/divisions/cr/2016/06/22/marine-ice-sheet-instability-for-dummies-2/).)
